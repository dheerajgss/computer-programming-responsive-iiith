window.view = {
	...
	activateClicks: function() {
		...
		this.addClickEvent('imageRTriangle', function() { view.showRTriangleInputs() })
		this.addClickEvent('okRTriangle', function() { view.validateRTriangleInputs() })
	...
	showSquareInputs: function() {
		this.hideQuestionBlock('questionRTriangle', 'imageRTriangle')
	...
	showRTriangleInputs: function() {
		this.hideQuestionBlock('questionSquare', 'imageSquare')
		this.hideQuestionBlock('questionCircle', 'imageCircle')
		this.hideQuestionBlock('questionTriangle', 'imageTriangle')
		this.showQuestionBlock('questionRTriangle', 'imageRTriangle')
        this.hideInstructions()
		this.unCheckRadioButtons()
	},
	...
	approveRTriangleInputs: function() {
		this.displayFunctionForRTriangle()
        this.showInstructions()
		document.getElementById('questionRTriangle').className = 'questionBlock hide'
		document.getElementById('imageRTriangle').className += ' disabledImage'
		document.getElementById('tickRTriangle').className = 'tick'
		document.getElementById('imageRTriangle').style.opacity = '0.3'
		this.i ++
		this.replaceDivs()
	},
	...
	validateRTriangleInputs: function() {
		var options1, options2, options3, options4
		var a, b, c, d
		...
		if ( a !== '2')
			alert('Incorrect value of input variables(arguments). Calculating the area of a right angle triangle requires the length of the base and height of the triangle. Try again.')
		else if ( b !== 'float' )
			alert('Incorrect datatype of input variables(arguments). The values of base and height of a right angle triangle need not be integers. Try again.')
		else if ( c !== 'float' )
	...
	displayFunctionForRTriangle: function() {
		document.getElementById('functionRTriangle').innerHTML += 'float area_right_triangle (float a,float b)<br>{<br> &emsp; float area = 0.5*a*b;<br> &emsp; return area;<br>}'
	},
	...
	resetToInitialState: function() {
		...
		document.getElementById('imageRTriangle').className = 'imageRTriangle'
		...
		document.getElementById('tickRTriangle').className = 'tick hide'
		...
		document.getElementById('functionRTriangle').innerHTML = ''
